...
class NumberCounterNode(Node):
    def __init__(self):
        ...
        self.number_subscriber_ = self.create_subscription(
            Float64, "timer", self.callback_timer, 1)
    ...
    def callback_timer(self, msg: Float64):
        self.timer_count += msg.data
        self.get_logger().info(f'Timer callback triggered. Count: {self.timer_count}')
